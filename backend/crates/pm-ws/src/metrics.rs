...
impl Metrics {
    ...
    pub fn connection_established(&self, tenant_id: &str) {
        ...
        counter!(format!("{}.connections.established.{}", self.prefix, tenant_id)).increment(1);
    ...
    pub fn connection_closed(&self, tenant_id: &str, reason: &str) {
        ...
        counter!(format!("{}.connections.closed.{}.{}", self.prefix, tenant_id, reason)).increment(1);
    ...
    pub fn message_received(&self, tenant_id: &str, message_type: &str) {
        ...
        counter!(format!("{}.messages.received.{}", self.prefix, message_type)).increment(1);
        counter!(format!("{}.messages.received.{}.{}", self.prefix, tenant_id, message_type)).increment(1);
    }
    ...
    pub fn message_sent(&self, tenant_id: &str, message_type: &str) {
        ...
        counter!(format!("{}.messages.sent.{}.{}", self.prefix, tenant_id, message_type)).increment(1);
    }
    ...
    pub fn error_occurred(&self, tenant_id: &str, error_type: &str) {
        ...
        counter!(format!("{}.errors.{}.{}", self.prefix, tenant_id, error_type)).increment(1);
    }

    /// Record message processing latency
    pub fn message_latency(&self, duration: std::time::Duration) {
        histogram!(format!("{}.messages.latency_ms", self.prefix)).record(duration.as_millis() as f64);
    }
    ...
    pub fn subscription_changed(&self, tenant_id: &str, action: &str) {
        ...
        counter!(format!("{}.subscriptions.{}.{}", self.prefix, tenant_id, action)).increment(1);
    }

    /// Update connection count for tenant
    pub fn update_tenant_connection_count(&self, tenant_id: &str, count: usize) {
        gauge!(format!("{}.connections.per_tenant.{}", self.prefix, tenant_id)).set(count as f64);
    }
}
