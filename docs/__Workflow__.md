...
### Other
```text
Read `CRITICAL_OPERATING_CONSTRAINTS.md`, `docs/session-plans/session-20.1-plan.md`, `docs/session-plans/session-20-plan.md` and `docs/implementation-plan-v2.md`
