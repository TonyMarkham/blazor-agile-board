...
### Step 1: Fix `Config::config_dir()` — The Foundation
...
### Step 3: Remove env var comments from config files
...
### Step 4: Add pm-config Dependency to Tauri
