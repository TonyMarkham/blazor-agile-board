...
- Validate project exists, name non-empty, end_date > start_date
- Create `Sprint::new(project_id, name, goal, start_date, end_date, user_id)`
...
- `SprintRepository::delete()` (soft delete)
