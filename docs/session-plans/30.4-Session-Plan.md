...
- [ ] WorkItemRow displays correctly with all badges and actions
- [ ] KanbanCard supports drag-and-drop (both mouse and keyboard)
- [ ] VersionConflictDialog shows all three resolution options clearly
- [ ] WorkItemDialog validates input and handles version conflicts
- [ ] WorkItemList filters and virtualizes large lists correctly
- [ ] KanbanColumn displays empty state and item count
- [ ] KanbanBoard keyboard navigation works with arrow keys and Space
- [ ] All components handle connection state changes appropriately
- [ ] Accessibility features work (ARIA labels, keyboard navigation, screen reader announcements)
