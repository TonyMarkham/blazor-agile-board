...
# Expected: 619+ tests passing (4 new tests added)
```
...
- [ ] `just test-frontend` passes (619+ tests)
- [ ] ProjectDetail has "Sprints" tab
- [ ] WorkItemDetail has "Comments" section
- [ ] Home page shows active sprint count
...
| File | Change |
|------|--------|
| `ProjectManagement.Wasm/Pages/ProjectDetail.razor` | Add Sprints tab with full CRUD |
...
| `ProjectManagement.Components.Tests/Pages/PageIntegrationTests.cs` | Add 4 integration tests |
