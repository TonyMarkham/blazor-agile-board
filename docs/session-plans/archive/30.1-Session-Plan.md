...
- [x] `dotnet build ProjectManagement.Core` passes
- [x] `dotnet build ProjectManagement.Components` passes
- [x] All 4 CSS files created in wwwroot/css/
- [x] ViewModels folder created with 4 files
- [x] All tests pass
